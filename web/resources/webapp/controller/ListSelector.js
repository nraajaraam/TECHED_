sap.ui.define([
		...
		return BaseObject.extend("development.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias development.model.ListSelector
			 */
			 ...
			 * @return {development.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
