sap.ui.define([
	...
	return BaseObject.extend("development.model.GroupSortState", {
		 ...
		 * @alias development.model.GroupSortState
		 */
		...
		/**
		 * Sorts by TEXT, or by GROSSAMOUNT
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GROSSAMOUNT") {
				...
				this._oViewModel.setProperty("/sortBy", "TEXT");
			}
